...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Education}
\cventry{2019--2022}{PhD In Statistics}{\icj{}, \ucbl{} and \scor{}}{}{}{
    {\footnotesize \textbf{Title:} {Dependences structures and risk aggregation}\\
    \textbf{Advisors:} Esterina Masiello, Véronique Maume-Deschamps and Didier Rullière.\\
    \textbf{Keywords:} {Dependence structures, Thorin measures, Laguerre basis, copulas, non-parametric estimation, high-dimensional statistics}\\
    \textbf{Funding:} CIFRE grant between SCOR SE and University Lyon 1.\\
    \textbf{Earing date:} May the 30th, 2022\\
    \textbf{Jury :} \\[0.25em]
