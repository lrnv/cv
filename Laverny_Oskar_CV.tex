...
\textit{UMR 1252 SESSTIM, AMU} \\[0.5em]
{\footnotesize
  \bull{Research:} My current research directions are toward understanding relative survival datasets extracted from cancer registries. This applied direction yields theoretical problematics in survival analysis and statistical theory around them. In particular, I am a specialist of dependence structures modeling and copulas. More precisly, my work can be categorized in the folowing fields:
  \begin{itemize}
  ...
  \end{itemize}
  \bull{Teaching:} I teach statistics and CS at SESSTIM, in the M2 Artificial Intelligence for Public Health (AI4PH)  \& M2 Quantitative methods for health research (MQERS), in French and English:
  \textbf{Multivariate exploratory methods:} PCA, ICA, PLS regression, ANOVA. 
  \textbf{Regression:} Linear models, Logistic models, GLM, Mixed effects models. 
  \textbf{Machine learnings:} K-means, SVM, Cart, Random forest, Neural nets. 
  \textbf{Survival analysis:} Cox-PH, NA, Kaplan-Meier, Mixed effects.
  \textbf{Computer science:} Julia, Python, R.
}
}
...
\tabcv{2019 - 2022}{
\textbf{PhD in statistics} \;\textit{ICJ (Lyon 1) and SCOR SE},\\[0.5em]
...
\subsection{Obtained grants}
\tabcv{2025-2027}{\textbf{\href{https://sesstim.univ-amu.fr/fr/projet/netplus}{NETPLUS} project:} Censored deconvolution for net survival\\
{\footnotesize
Funds from the Cancéropôle PACA "Emergence" call. 
}}
\tabcv{2025-2029}{\textbf{\href{https://anr.fr/fileadmin/aap/2025/selection/aapg-2025-selection.pdf}{LOSTLIFE} project:} Lost life w.r.t. cancer: deconvolutional approaches in relative survival\\
{\footnotesize
ANR JCJC AAPG 2025. 
}}

\subsection{Management}
\tabcv{Summer 2024}{\textbf{M2 Internship}\\
{\footnotesize
\textbf{Rim Alahjal}, on \textit{Relative survival analysis in Julia}. Currently doing a PhD, CNRS/INRIA, Grenoble.
}}
\tabcv{Summer 2025}{\textbf{M2 Internship}\\
{\footnotesize
\textbf{Sonia-Maitri Bude}, on \textit{Behind the cox model: a performance study}.\\
\textbf{Taha Lachab}, on \textit{Censored deconvolution for net survival}, on the NETPLUS project.
}}
\tabcv{2025-2026}{\textbf{Ingénieur d'études}\\
{\footnotesize
\textbf{Taha Lachab}, on \textit{Censored deconvolution for net survival}, on the NETPLUS project.
}}
\tabcv{Summer 2026}{\textbf{M2 Internship}\\
{\footnotesize
\textbf{Julian Morales}, on \textit{Testing relative survival vs comptitive risks results on SEER data}, a student from Columbia University hosted in Marseille.\\
\textbf{Ilyan Topari}, on \textit{Identifiability of archimedean copulas under dependent censoring}
}}

\subsection{Research stays}
\tabcv{June 2024}{\textbf{Invited scholar}\\
{\footnotesize
Invited at University College London by Dr F. J. Rubio (one week).
}}

\subsection{Event organization}
\tabcv{2024}{\textbf{Member of the organizing comitee of HEARSTAT2024}\\
{\footnotesize
4th Corsican Summer School on Modern Methods in Biostatistics and Epidemiology, Corte.
}}

\tabcv{2025}{\textbf{Member of the organizing comitee of JDS2025}\\
{\footnotesize
56th Journées de statistiques de la SFdS, Marseille.
}}
...
\subsectionbib{S}{preprint}         {Preprints}
